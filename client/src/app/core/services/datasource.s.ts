...
export class DataSourceService extends BaseService{
  ...
  // public update( x: DataSource ) :Observable<DataSource>{
  //   return this
  //     .http
  //     .put( `${this.baseUri}/datasources/${x.id}`, x, this.headers )
  //     .pipe( 
  //       map( (x:any) => this.convertDataSource( x ) ) );
  // }
  ...
  // public get( id: number ) : Observable<DataSource>{
  //   return this
  //     .http
  //     .get( `${this.baseUri}/datasources/${id}`, this.headers )
  //     .pipe( 
  //       map( (x:any) => this.convertDataSource( x ) ) );
  // }

  // public ping( x: DataSource ):Observable<any>{
  //   return this
  //     .http
  //     .get( `${this.baseUri}/datasources/ping/${x.id}`, this.headers );
  //     //.get( `${this.baseUri}/datasources/ping/1` );
  // }
