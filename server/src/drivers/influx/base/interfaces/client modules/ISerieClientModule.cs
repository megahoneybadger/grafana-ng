...
namespace ED.Drivers.Influx
{
	...
	public interface ISerieClientModule
	{
		...
		/// <returns></returns>
		Task<IEnumerable<SerieSet>> GetSeriesAsync( string dbName,
		...
		/// <param name="filters">A collection of "WHERE" clause filters (optional).</param>
		/// <returns></returns>
		Task<IInfluxDataApiResponse> DropSeriesAsync( string dbName,
		...
		/// <param name="filters">A collection of "WHERE" clause filters (optional).</param>
		/// <returns></returns>
		Task<IEnumerable<Measurement>> GetMeasurementsAsync( string dbName,
