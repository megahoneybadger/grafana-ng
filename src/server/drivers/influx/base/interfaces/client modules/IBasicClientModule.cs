...
namespace ED.Drivers.Influx
{
	public interface IBasicClientModule
	{
		...
		/// <returns></returns>
		Task<IEnumerable<Serie>> QueryAsync( string query,
		...
		/// <param name="chunkSize">Maximum number of rows per chunk. (OPTIONAL)</param>
		/// <returns></returns>
		Task<IEnumerable<Serie>> QueryAsync( IEnumerable<string> queries,
			string dbName = null, string epochFormat = null, long? chunkSize = null );
		/// <summary>
		...
		/// <param name="chunkSize">Maximum number of rows per chunk. (OPTIONAL)</param>
		/// <returns></returns>
		Task<IEnumerable<Serie>> QueryAsync( string queryTemplate,
		...
		/// <param name="chunkSize">Maximum number of rows per chunk. (OPTIONAL)</param>
		/// <returns></returns>
		Task<IEnumerable<IEnumerable<Serie>>> MultiQueryAsync( IEnumerable<string> queries,
			string dbName = null, string epochFormat = null, long? chunkSize = null );
		/// <summary>
